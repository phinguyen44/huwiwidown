...
# Leave titlepage and abstract YAML frontmatter alone
titlepage: |  
  `r if(knitr:::is_latex_output()) paste(readLines("prelim/00-titlepage.Rmd"), collapse = '\n  ')`
abstract: |  
...
# Add / remove optional elements by commenting out
acknowledgements: |  
