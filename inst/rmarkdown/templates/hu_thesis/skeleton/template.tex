...
% save thesis parameter for later
...
% note that references is also contained here.
% appendix and and declaration of authorship are contained in another
% tex file to ensure the follow the references.
